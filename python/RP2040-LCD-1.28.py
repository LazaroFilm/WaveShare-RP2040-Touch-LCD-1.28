...
def DOF_READ():
    ...
    while True:
        ...
        LCD.text("ACC_X={:+.2f}".format(wxyz[0]), 20, 100 - 3, LCD.white)
        LCD.text("ACC_Y={:+.2f}".format(wxyz[1]), 20, 140 - 3, LCD.white)
        LCD.text("ACC_Z={:+.2f}".format(wxyz[2]), 20, 180 - 3, LCD.white)

        LCD.fill_rect(120, 80, 120, 120, 0xF073)
        LCD.text("QUA_X={:+3.2f}".format(wxyz[0]), 125, 100 - 3, LCD.white)
        LCD.text("QUA_Y={:+3.2f}".format(wxyz[1]), 125, 140 - 3, LCD.white)
        LCD.text("QUA_Z={:+3.2f}".format(wxyz[2]), 125, 180 - 3, LCD.white)
